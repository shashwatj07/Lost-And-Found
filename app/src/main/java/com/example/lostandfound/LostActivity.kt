    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val temp = dataSnapshot.child("Lost").children
                for (item in temp){
                    var desc = item.child("description").value.toString()
                    var itemName = item.child("itemname").value.toString()
                    var lostFoundDate = "Date Lost: "+item.child("lostfoundDate").value.toString()
...
//                Log.i("Last mein","Main List of items are: $lostItemsList")
        ...
        setUpToolbar()
        supportActionBar?.title="Lost Items"
        navigationView.setCheckedItem(R.id.nav_item_two)
        val actionBarDrawerToggle=
            ActionBarDrawerToggle(this@LostActivity,drawerLayout, R.string.open_drawer, R.string.close_drawer)
        ...
        navigationView.setNavigationItemSelectedListener {
            ...
            when(it.itemId)
            {
                ...
                R.id.nav_item_two->{
                    startActivity(Intent(this@LostActivity, LostActivity::class.java))
                }
                R.id.nav_item_three->{
                    startActivity(Intent(this@LostActivity, FoundActivity::class.java))
                }
                R.id.nav_item_four->{
                    val intent = Intent(this@LostActivity, FormActivity::class.java)
                    startActivity(intent)
                }
                R.id.nav_item_five->{
                ...
                R.id.nav_item_nine->{
                    ...
                    val intent = Intent(this@LostActivity, LoginActivity::class.java)
